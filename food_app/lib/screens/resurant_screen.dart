...
class _RestaurantScreen extends State<RestaurantScreen> {
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _createClassBtn(20.0, 20.0, "Reviews"),
              _createClassBtn(20.0, 20.0, "Contact")
            ],
          ),
          ...
          Expanded(
            child: GridView.count(
              ...
              crossAxisCount: 2,
              children: List.generate(3, (i) => _buildMenuItem(widget, i)),
            ),
          ),
        ],
      ),
  ...
  _createClassBtn(double height, double width, String text) {
  ...
  _buildMenuItem(RestaurantScreen widget, int index) {
    var food = widget.restaurant.menu[index];
    return Center(
      child: Stack(
